...
import LocationList from '../../components/LocationList'; // Adjust path
...
const Index = () => {
  ...
  const handleShowBusStop = () => {
    ...
    const updateDeviceType = () => {
      ...
      setIsMobile(width <= 600); // Mobile if width <= 600 DP, tablet otherwise
    };
  ...
  const handleStartPointClick = (location: Location) => {
    ...
    setSearchQuery(location.name); // Display selected location in input
    setDropOffSearchQuery(''); // Clear drop-off search to show all dropPoints
    setIsSelectingDropOff(true); // Switch to drop-off selection
  ...
  const clearStartingPoint = () => {
    ...
    setIsSelectingDropOff(false); // Reset to selecting starting point
    setSelectedDropPoint(null); // Clear drop-off point
  };
              ...
              <View style={styles.inputContainer}>
                ...
                <View style={styles.inputRow}>
                  ...
                  <View style={styles.textInputContainer}>
                    ...
                    />
                    {dropOffSearchQuery && (
                      <TouchableOpacity onPress={() => setDropOffSearchQuery('')}>
                        <Svg width={wp(3.25)} height={wp(3)} viewBox="0 0 13 12" fill="none">
                          <Path
                            d="M3.7 9.5L3 8.8L5.8 6L3 3.2L3.7 2.5L6.5 5.3L9.3 2.5L10 3.2L7.2 6L10 8.8L9.3 9.5L6.5 6.7L3.7 9.5Z"
                            fill="black"
      ...
      <View style={{
        ...
        <View>
         <Text style={{
          ...
          color : 'black'
         }}>2 Buses</Text>  are approaching <Text style={{
          color : 'black'
         }}>Brunei</Text></Text>
